...
class TestCase(unit.TestCase):
    ...
    def test_datelist(self):
        ...
        for i in range(1,len(trs)):
            success=trs[i].find_tags('td')[1].text
            fail=trs[i].find_tags('td')[2].text
            total=trs[i].find_tags('td')[3].text
        ...
        list_success=table.find_tags('td')[1].text
        list_fail=table.find_tags('td')[2].text
        list_total=table.find_tags('td')[3].text
        ...
        text=table.find_tags('td')[4].text
