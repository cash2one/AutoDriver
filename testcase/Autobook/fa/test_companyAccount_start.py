...
class TestCase(unit.TestCase):
    ...
    def test_list_operation_start(self):
        ...
        self.assertTrue(u'已禁用' in station_text,u'没有找到指定字符串')
        ...
        print text1
        self.assertTrue(u'确定启用该账户?' in text1,u'没有找到指定字符串')
        ...
        print station_text1
        self.assertTrue(u'正常' in station_text1,u'没有找到指定字符串')
        ...
        self.assertTrue(u'确定将该账户设为默认账户吗?' in text7,u'没有找到指定字符串')
        ...
        print station_text3
        self.assertTrue(u'是' in station_text3,u'没有找到指定字符串')
        ...
        print text5
        self.assertTrue(u'确定禁用该账户?' in text5,u'没有找到指定字符串')
        ...
        print station_text6
        self.assertTrue(u'已禁用' in station_text6,u'没有找到指定字符串')
