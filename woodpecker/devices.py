...
class RecordingForm(QWidget, recording_ui.Ui_Form):
    def __init__(self, parent_size):
        ...
        self.con_height = parent_size - 320  # toolbar+输出框+内边距
        self.img_label.setMinimumHeight(self.con_height)
        self.img_label.setMaximumHeight(self.con_height)
    ...
    def screenshot(self):
        ...
        self.png = self.resize_image(self.origin_png, self.con_height)
