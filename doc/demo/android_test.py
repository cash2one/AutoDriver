...
class ContactsAndroidTests(unittest.TestCase):
    def setUp(self):
        ...
        desired_caps['app'] = PATH(
            '../libs/ContactManager.apk'
        )
        desired_caps['appPackage'] = 'com.example.mychevy.contactmanager'
    ...
    def test_add_contacts(self):
        ...
        textfields = self.driver.find_elements_by_class_name("mychevy.widget.EditText")
